...
$host = 'sql106.infinityfree.com';          // Replace with your SQL host from InfinityFree
$dbname = 'if0_40094624_portfolio_db'; // Replace with your database name
$username = 'if0_40094624';            // Replace with your database username  
$password = '4n2iVyofcMT';    // Replace with your database password
